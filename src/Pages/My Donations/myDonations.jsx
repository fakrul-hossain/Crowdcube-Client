      ...
      {donations.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {donations.map((donation) => (
            <div
              key={donation._id}
              className="group block bg-white rounded-lg shadow-md overflow-hidden p-4"
            >
              <img
                src={donation.image}
                alt={donation.title}
              ...
              />
              <div className="mt-4">
                <h3 className="text-xl font-bold text-teal-700 group-hover:underline group-hover:underline-offset-4">
                  {donation.title}
                </h3>
