  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {campaigns.length > 0 ? (
          campaigns.slice(0, 6).map((campaign) => (
            <div
              key={campaign._id}
              className="w-full bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300 px-4 md:px-6 lg:px-8 mx-auto"
            >
              <img
                src={campaign.image}
                alt={campaign.title}
              ...
              <div className="p-6">
                ...
                <button className="w-full bg-teal-600 text-white py-2 px-4 rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 mb-2"
                >
                  See More
                </button>
                </Link>
      ...
      <div className="text-center mt-8">
        <Link to={'/campaigns'}>
        <button
          className="bg-teal-600 text-white py-2 px-6 rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
        >
          Show All Campaigns
        </button>
        </Link>
